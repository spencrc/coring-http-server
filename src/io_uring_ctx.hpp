...
class io_uring_ctx {
  public:
	...
	void accept_direct(int sockfd, void *data, unsigned int file_index,
					   unsigned int sqe_flags);
	void read(int clientfd, std::array<char, BUFFER_LEN> *buf, void *data,
			  unsigned int sqe_flags);
	void write(int clientfd, std::array<char, BUFFER_LEN> *buf,
			   unsigned int write_len, void *data, unsigned int sqe_flags);
